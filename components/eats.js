  ...
  return (
    <div>
        ...
        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md">
                ...
                <div className="p-5">
                    <p className='text-orange-500'>Eats</p>
                    <a href="#">
                        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900">Dhanshiri Restaurant, Chakaria</h5>
                    </a>
                    <p className='text-sm text-gray-400'>4/5 (20 ratings)</p>
            ...
            <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md">
                <a href="#">
                    <img className="rounded-t-lg object-cover h-80" src="https://lh3.googleusercontent.com/p/AF1QipPcV5KlSd3zba2slTNg_DMWzXTeyqyRkegks_a9=s1360-w1360-h1020" alt="" />
                </a>
                <div className="p-5">
                    <p className='text-orange-500'>Eats</p>
                    <a href="#">
                        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900">Inani Resort, Harbang</h5>
                    </a>
                    <p className='text-sm text-gray-400'>3.5/5 (5.4k ratings)</p>
            ...
            <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md">
                <a href="#">
                    <img className="rounded-t-lg object-cover h-80" src="https://lh5.googleusercontent.com/p/AF1QipMPHjb9A641D63EcOA1UR4lWE5CW1m8Emo9h7hU=w408-h252-k-no" alt="" />
                </a>
                <div className="p-5">
                    <p className='text-orange-500'>Eats</p>
                    <a href="#">
                        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900">The Royal Coastal, Badarkhali</h5>
                    </a>
                    <p className='text-sm text-gray-400'>4.1/5 (54 ratings)</p>
            ...
            <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md">
                <a href="#">
                    <img className="rounded-t-lg object-cover h-80" src="https://lh3.googleusercontent.com/p/AF1QipN1EXOy8EaDOUJpnqwscjkFL1vzW5_gLD5_jck4=s1360-w1360-h1020" alt="" />
                </a>
                <div className="p-5">
                    <p className='text-orange-500'>Eats</p>
                    <a href="#">
                        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900">Burger Eat Chakaria</h5>
                    </a>
                    <p className='text-sm text-gray-400'>4/5 (14 ratings)</p>
