...
function Hero() {
  return (
    <div style={{backgroundImage : "url('assets/background-ariful.jpg')"}} className="bg-cover">
       <div className="py-48 px-32 h-screen grid grid-cols-2">
            <div className='mx-auto py-4 text-white'>
                <p className='text-lg'>project</p>
                <h1 className='text-9xl font-bold'>Chakaria</h1>
            ...
            <div className='grid grid-cols-2 space-x-4 m-8'>
                <div className='space-y-4'>
                    <div className='bg-orange-400 text-white p-16 rounded-xl shadow'>Stay</div>
                    <div className='bg-red-400 text-white p-16 rounded-xl shadow'>Eat</div>
                </div>
                <div className='space-y-4'>
                    <div className='bg-green-400 text-white p-16 rounded-xl shadow'>See</div>
                    <div className='bg-pink-400 text-white p-16 rounded-xl shadow'>Map</div>
                </div>
            </div> 
       </div>
    </div>
